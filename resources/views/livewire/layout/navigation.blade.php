        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" wire:navigate class="text-lg font-bold text-gray-900 tracking-tight">
                        {{ config('app.name', 'Kinkoza') }}
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:gap-4 sm:ms-6">
                <div class="flex items-center gap-1 text-xs font-medium">
                    <a href="{{ route('locale.switch', 'en') }}" class="{{ app()->getLocale() === 'en' ? 'text-gray-900' : 'text-gray-400 hover:text-gray-600' }}">EN</a>
                    <span class="text-gray-300">|</span>
                    <a href="{{ route('locale.switch', 'fr') }}" class="{{ app()->getLocale() === 'fr' ? 'text-gray-900' : 'text-gray-400 hover:text-gray-600' }}">FR</a>
                </div>
            ...
            <div class="-me-2 flex items-center gap-2 sm:hidden">
                <div class="flex items-center gap-1 text-xs font-medium">
                    <a href="{{ route('locale.switch', 'en') }}" class="{{ app()->getLocale() === 'en' ? 'text-gray-900' : 'text-gray-400' }}">EN</a>
                    <span class="text-gray-300">|</span>
                    <a href="{{ route('locale.switch', 'fr') }}" class="{{ app()->getLocale() === 'fr' ? 'text-gray-900' : 'text-gray-400' }}">FR</a>
                </div>
